...
public class Utility extends ManageDriver {
    ...
    public void doSendKeysToElement(By by, CharSequence keys) {
        driver.findElement(by).sendKeys(keys);
    }

    public void doSendKeysToElement(WebElement element, CharSequence keys) {
...
//import org.openqa.selenium.JavascriptExecutor;
    ...
    // Simple method to move slider
    public void moveSlider(WebElement element) {
        for (int i = 1; i <= 75; i++) {
            element.sendKeys(Keys.ARROW_LEFT);
            // Change Arrow key according to your needs
        }
